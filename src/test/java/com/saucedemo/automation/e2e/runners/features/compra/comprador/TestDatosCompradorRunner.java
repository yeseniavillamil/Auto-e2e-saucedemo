...
package com.saucedemo.automation.e2e.runners.features.compra.comprador;
...
@SelectClasspathResource(RunnerConstants.PACKAGE_FEATURES+ TestDatosCompradorRunner.FEATURE_FILE+".feature")
...
public class TestDatosCompradorRunner
{
    ...
    static final String FEATURE_FILE = FEATURE_DIR+"/comprador";
