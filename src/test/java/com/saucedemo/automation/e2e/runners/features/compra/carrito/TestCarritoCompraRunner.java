...
package com.saucedemo.automation.e2e.runners.features.compra.carrito;
...
@SelectClasspathResource(RunnerConstants.PACKAGE_FEATURES+ TestCarritoCompraRunner.FEATURE_FILE+".feature")
...
public class TestCarritoCompraRunner
{
    ...
    static final String FEATURE_FILE = FEATURE_DIR+"/carrito";
